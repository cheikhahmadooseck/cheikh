...
class CancelRasonRequestApiController extends GetxController implements GetxService {
  ...
  cancelreasonApi(context) async{
    ...
    var response = await http.get(Uri.parse(Config.baseurl + Config.vehicalcancelreason),headers: userHeader);
