...
class VihicalCancelRideApiController extends GetxController implements GetxService {
  VihicalRideCancelModel? vihicalRideCancelModel;

  Future vihicalcancelapi({context,required String uid,required String lat,required String lon,required String cancel_id,required String request_id}) async {
    Map body = {
      "uid": uid,
    ...
    var response = await http.post(Uri.parse(Config.baseurl + Config.vihicalcancelride),
