...
class VihicalCalculateController extends GetxController implements GetxService {
  ...
  Future vihicalcalculateApi({context,required String uid,required String mid,required String pickup_lat_lon,required String drop_lat_lon,required List drop_lat_lon_list}) async {
    Map body = {
      "uid": uid,
      "mid": mid,
    ...
    var response = await http.post(Uri.parse(Config.baseurl + Config.vihicalcalculate),
