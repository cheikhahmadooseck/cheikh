...
class Config {
  ...
  static String mapkey = "AIzaSyB-Vi0HNjZs8eNOMMTazt-T01Gw6EYckHg";

  static String baseurl = 'https://zippygo.cscodetech.cloud/customer/';
  static String imageurl = 'https://zippygo.cscodetech.cloud/';
