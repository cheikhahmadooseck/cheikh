...
Widget CommonOutLineButton({String? txt1,String? txt2,required Color bordercolore,context,required void Function() onPressed1,Color? clore}){
  ...
  return  Container(
      ...
      child: OutlinedButton(
        style: ButtonStyle(shape: const MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10)))),side: MaterialStatePropertyAll(BorderSide(color: bordercolore))),
        onPressed: onPressed1,
        child: Center(
          child: RichText(text: TextSpan(
              children: [
                TextSpan(text: txt1,style:  TextStyle(fontSize: 15,color: notifier.textColor,fontFamily: "SofiaRegular")),
