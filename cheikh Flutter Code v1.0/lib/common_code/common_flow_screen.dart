                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        title: Text("Finding Ride for you",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: notifier.textColor),),
                        subtitle: Text("$vihicalname ride",style: TextStyle(color: notifier.textColor,fontWeight: FontWeight.bold,fontSize: 14),),
                        trailing: InkWell(
                          onTap: () {
                          ...
                          child: Container(
                            ...
                            child: Center(child: Text("Trip Details",style: TextStyle(color: notifier.textColor),),),
                          ),
                        ),
                      ),
                      const SizedBox(height: 10,),
                      ...
                      const SizedBox(height: 10,),
                      lottie.Lottie.asset('assets/lottie/find.json',height: 200),
                      const SizedBox(height: 10,),
                      ...
                      },context: context,txt1: "Cancel Request")
                    ],
                  ),
                ),
              ),
...
Future commonbottomsheetcancelflow({required context}){
  ...
  VihicalCancelRideApiController vihicalCancelRideApiController = Get.put(VihicalCancelRideApiController());
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      contentPadding: EdgeInsets.zero,
                      leading: Image(image: NetworkImage("${Config.imageurl}$vihicalimage"),height: 40,),
                      title: Text("Traveling by",style: TextStyle(color: notifier.textColor),),
                      subtitle: Text("$vihicalname ride",style: TextStyle(color: notifier.textColor,fontWeight: FontWeight.bold),),
                    ),
                    const SizedBox(height: 10,),
                    loadertimer == true ? const SizedBox() : const CounterBottomSheet(),
                    const SizedBox(height: 20,),
                    Text("Location Details",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: notifier.textColor),),
                    Column(
                      children: [
                        Padding(
                                    ...
                                    children: [
                                      Transform.translate(
                                        ...
                                        child: ListTile(
                                          // isThreeLine: true,
                                          contentPadding: EdgeInsets.zero,
                                          title: Text("${picktitle == "" ? addresspickup : picktitle}",style: TextStyle(color: notifier.textColor),),
                                      ...
                                      Transform.translate(
                                        ...
                                        child: ListTile(
                                          // isThreeLine: true,
                                          contentPadding: EdgeInsets.zero,
                                          title: Text(droptitle,style: TextStyle(color: notifier.textColor),),
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          ListTile(
                                            // isThreeLine: true,
                                            contentPadding: EdgeInsets.zero,
                                            title: Text("${droptitlelist[index]["title"]}",style: TextStyle(color: notifier.textColor),),
                        ...
                        driveridloader == true ? Transform.translate(
                          offset: const Offset(0, -40),
                          child: ListView.builder(
                            physics: const NeverScrollableScrollPhysics(),
                            padding: EdgeInsets.zero,
                    ...
                    Row(
                      children: [
                        Text("Total Fare",style: TextStyle(color: notifier.textColor,fontWeight: FontWeight.bold,fontSize: 16)),
                        const Spacer(),
                        Text("$globalcurrency $vihicalrice",style: TextStyle(color: notifier.textColor,fontWeight: FontWeight.bold,fontSize: 16))
                      ],
                    ),
                    const SizedBox(height: 10,),
                    const Text("Paying via cash",style: TextStyle(color: Colors.grey,fontSize: 14),),
                    // const Spacer(),
                    // const SizedBox(height: 40,),
                    const SizedBox(height: 10,),
                    statusridestart == "5" ? const SizedBox() : CommonOutLineButton(bordercolore: theamcolore, onPressed1: () {
                      Get.back();
                      Get.bottomSheet(
                          StatefulBuilder(builder: (context, setState) {
                            return Stack(
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        const SizedBox(height: 20,),
                                        Text("Why do you want to cancel?",style: TextStyle(color: notifier.textColor,fontSize: 20,fontWeight: FontWeight.bold),),
                                        const SizedBox(height: 10,),
                                        Text("Please provide the reason for cancellation",style: TextStyle(color: notifier.textColor),),
                                        const SizedBox(height: 20,),
                                        Expanded(
                                          child: ListView.separated(
                                            // physics: const NeverScrollableScrollPhysics(),
                                              ...
                                              itemCount: cancelRasonRequestApiController.cancelReasonModel!.rideCancelList!.length,
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      InkWell(
                                                        onTap: () {
                                                          setState((){
                                                            cancel_id = cancelRasonRequestApiController.cancelReasonModel!.rideCancelList![index].id.toString();
                                                            Get.back();
                                                            Get.bottomSheet(
                                                                StatefulBuilder(builder: (context, setState) {
                                                                  return Stack(
                                                                        ...
                                                                        child: Padding(
                                                                          ...
                                                                          child: Column(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              lottie.Lottie.asset("assets/lottie/canceljson.json"),
                                                                              Text("Are you sure you want to cancel this ride?",style: TextStyle(color: notifier.textColor,fontSize: 22),maxLines: 2,),
                                                                              const SizedBox(height: 20,),
                                                                              Text("We have found captains near you, please wait for a while, your ride should be confirmed any minutes.",style: TextStyle(color: notifier.textColor,fontSize: 16),maxLines: 2,),
                                                                              const Spacer(),
                                                                              CommonOutLineButton(bordercolore: theamcolore, onPressed1: () {},context: context,txt1: "Keep searching"),
                                                                              const SizedBox(height: 5,),
                                                                              CommonButton(containcolore: theamcolore, onPressed1: () {

                                                                                vihicalCancelRideApiController.vihicalcancelapi(uid: useridgloable.toString(), lat: lathomecurrent.toString(), lon: longhomecurrent.toString(), cancel_id: cancel_id.toString(), request_id: request_id.toString()).then((value) {
                                                                              ...
                                                                              },context: context,txt1: "Cancel my ride"),
                                                                              const SizedBox(height: 5,),
                                                                            ],
                                                                          ),
                                                                        ),
                                                                      ...
                                                                      Positioned(
                                                                        ...
                                                                        child: InkWell(
                                                                          ...
                                                                          child: Container(
                                                                              ...
                                                                              child: Center(child: Image(image: AssetImage("assets/close.png"),height: 20,color: notifier.textColor,))),
                                                                        ),
                                                                      )
                                                                    ],
                                                                  );
                                                        ...
                                                        child: ListTile(
                                                          ...
                                                          title: Text("${cancelRasonRequestApiController.cancelReasonModel!.rideCancelList![index].title}",style: TextStyle(color: notifier.textColor),),
                                                          trailing:  Image(image: AssetImage("assets/angle-right-small.png"),height: 25,color: notifier.textColor,),
                                                        ),
                                                      ),
                    ...
                    },context: context,txt1: "Cancel Ride"),
                    const SizedBox(height: 10,),
                    CommonButton(containcolore: theamcolore, onPressed1: () {
                      Get.back();
                    },context: context,txt1: "Back"),
                    const SizedBox(height: 10,),
                  ],
                ),
              ),
...
class GlobalDriverAcceptClass extends GetxController implements GetxService {
  ...
  driverdetailfunction({required String d_id,required String request_id,required context,required double lat,required double long}){
    ...
    socket.on('Vehicle_Ride_Payment$useridgloable', (Vehicle_Ride_Payment) {
      ...
      print("Vehicle_Ride_Payment1 total1........: ${Vehicle_Ride_Payment["ResponseCode"]}");
      print("Vehicle_Ride_Payment1 total1: ${Vehicle_Ride_Payment["price_list"]}");
      print("Vehicle_Ride_Payment1 total3: ${Vehicle_Ride_Payment["price_list"]["tot_price"]}");
      ...
      print("+++++(finaltotalsecounde finaltotalsecounde)++++++:---- $finaltotalsecounde");
    ...
    vihicalDriverDetailApiController.vihicaldriverdetailapi(uid: useridgloable.toString(), d_id: d_id, request_id: request_id).then((value) {

      print("object@@@@@@@5");
      if(value["Result"] == true){
        driveridloader == false ? tot_hour = value["accepted_d_detail"]["tot_hour"].toString() : "";
        driveridloader == false ? tot_time = value["accepted_d_detail"]["tot_minute"].toString() : "";
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context) => DriverDetailScreen(lat: lat,long: long),));
...
Future rateBottomSheet(){
  ...
  DriverReviewDetailApiController driverReviewDetailApiController = Get.put(DriverReviewDetailApiController());
  ...
  ReviewDataApiController reviewDataApiController = Get.put(ReviewDataApiController());
  ...
  return Get.bottomSheet(
    ...
    isDismissible: false,
    enableDrag: false,
    GetBuilder<ReviewDataApiController>(builder: (reviewDataApiController) {
      return reviewDataApiController.isLoading ? const SizedBox() : StatefulBuilder(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          SvgPicture.asset("assets/svgpicture/check-circle.svg",color: notifier.textColor,),
                          ...
                          Container(
                            ...
                            child:  Row(
                              ...
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Icon(Icons.help_outline,size: 21,color: notifier.textColor),
                                SizedBox(width: 3),
                                Text(
                                  "Help",
                                  style: TextStyle(
                      ...
                      Wrap(
                        ...
                        children: [
                          for (int a = 0; a < reviewDataApiController.reviewDataApiModel!.reviewList!.length; a++)
                              ...
                              return InkWell(
                                onTap: () {
                                  setState(() {
                                    ...
                                    reviewtitle = reviewDataApiController.reviewDataApiModel!.reviewList![a].title.toString();
                                    setState(() {
                                      if(reviewid.contains(reviewDataApiController.reviewDataApiModel!.reviewList![a].id)){
                                        reviewid.remove(reviewDataApiController.reviewDataApiModel!.reviewList![a].id);
                                        print("-------remove--------- ${reviewid}");

                                      }else{
                                        reviewid.add(reviewDataApiController.reviewDataApiModel!.reviewList![a].id);
                                        print("+++++++Add+++++++ ${reviewid}");
                                      }
                                    });
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color: reviewid.contains(reviewDataApiController.reviewDataApiModel!.reviewList![a].id) ? theamcolore : notifier.containercolore,
                                  ...
                                  child: Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                      Text(reviewDataApiController.reviewDataApiModel!.reviewList![a].title.toString(),style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 15,color: reviewid.contains(reviewDataApiController.reviewDataApiModel!.reviewList![a].id) ?  Colors.white : notifier.textColor)),
                                    ],
                                  ),
                                ),
                              );
                      ...
                      const SizedBox(height: 20),
                      CommonTextfiled200(txt: "Tell us more...", context: context,controller: reviewtextcontroller),
                      const SizedBox(height: 20),
                      CommonButton(txt1: "Done",onPressed1: () {
                        print("userid:-- ($useridgloable)");
                        print("driver_id:-- ($driver_id)");
                        print("reviewtextcontroller.text:-- (${reviewtextcontroller.text})");
                        print("tRate:-- ($tRate)");
                        print("ridecompleterequestid:-- ($ridecompleterequestid)");
                        driverReviewDetailApiController.reviewapi(def_review: reviewid,uid: useridgloable.toString(), d_id: "$driver_id", review: reviewtextcontroller.text, tot_star: "$tRate",request_id: "$ridecompleterequestid",context: context);
                      },containcolore: theamcolore,context: context),
                      const SizedBox(height: 10),
                      CommonOutLineButton(bordercolore: theamcolore, onPressed1: () {
                        Get.offAll(MapScreen());
                      },txt1: "Skip",context: context)
                    ],
                  ),
                ),
              ),
