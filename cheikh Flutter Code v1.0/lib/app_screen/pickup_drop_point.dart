...
import 'package:zippygo/api_code/map_api_get.dart';
import 'package:zippygo/app_screen/custom_location_select_screen.dart';
...
class PickupDropPoint extends StatefulWidget {
  ...
  const PickupDropPoint({super.key, required this.pagestate, required this.bidding});
...
class _PickupDropPointState extends State<PickupDropPoint> {
  ...
  MapSuggestGetApiController mapSuggestGetApiController = Get.put(MapSuggestGetApiController());
  ...
  getCurrentLatAndLong(double latitude, double longitude) async {
    ...
    await placemarkFromCoordinates(latitude, longitude).then((List<Placemark> placemarks) {
      addresspickup = '${placemarks.first.name}, ${placemarks.first.locality}, ${placemarks.first.country}';

      // pickupcontroller.text = addresspickup;

      // print("FIRST USER CURRENT LOCATION :-- $addresspickup");
      // print("111111111111111111111111111 :-- $latitudepick");
      // print("222222222222222222222222222 :-- $longitudepick");
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                        ...
                        children: [
                          InkWell(
                              onTap: () {
                                // Navigator.pop(context, RefreshData(true));
                                Get.offAll(const MapScreen());
                                print("++++dropcontroller++++:--- ${dropcontroller.text}");
                                // Get.back();
                          ...
                          picanddrop == false ?  Text("Pickup".tr,style: TextStyle(fontSize: 20,color: notifier.textColor)) : Text("Drop".tr,style: TextStyle(fontSize: 20,color: notifier.textColor)),
                          // const Spacer(),
                          // Container(
                          //   height: 45,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    TextField(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          mapSuggestGetApiController.mapApi(context: context,suggestkey: pickupcontroller.text);
                                        });
                                      },
                                      decoration: InputDecoration(
                                          ...
                                          hintText: "Searching for you on the map...".tr,
                                          hintStyle: TextStyle(color: notifier.textColor),
                                          // labelText: "Email",
                                          suffixIcon: pickupcontroller.text.isEmpty ? const SizedBox() : Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: Center(child: Image(image: AssetImage("assets/close.png"),height: 15,color: notifier.textColor,),),
                                              ),
                                            ),
                                          ),
                                    ...
                                    TextField(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          mapSuggestGetApiController.mapApi(context: context,suggestkey: dropcontroller.text);
                                      ...
                                      decoration:  InputDecoration(
                                          ...
                                          hintStyle: TextStyle(color: notifier.textColor),
                                          // labelText: "Email",
                                          suffixIcon: dropcontroller.text.isEmpty ? const SizedBox() : Padding(
                                            padding: const EdgeInsets.all(13),
                                            child: InkWell(
                                              onTap: () {
                                                setState((){
                      ...
                      textfieldlist.isEmpty ? const SizedBox() : ListView.builder(
                              ...
                              InkWell(
                                onTap: () {
                                  ...
                                  setState(() {
                                    ...
                                    print(">>>>>>>>>>>>>>>>textfieldlist<<<<<<<<<<<<<<<< ${textfieldlist}");
                                    print(">>>>>>>>>>>>>>>>onlypass<<<<<<<<<<<<<<<< ${onlypass}");
                                    print(">>>>>>>>>>>>>>>>destinationlat<<<<<<<<<<<<<<<< ${destinationlat}");
                                    print(">>>>>>>>>>>>>>>>droptitlelist<<<<<<<<<<<<<<<< ${droptitlelist}");
                                  });
                                ...
                                child: Transform.translate(
                                  ...
                                  child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Image(image: AssetImage("assets/close.png"),height: 15,color: notifier.textColor,),
                                      )),
                                ),
                              ),
                            ],
                      ...
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => CustomLocationSelectScreen(bidding: widget.bidding,pagestate: widget.pagestate,),));
                            },
                            child: Container(
                              height: 40,
                              width: 150,
                              ...
                              Row(
                                ...
                                children: [
                                  Icon(Icons.pin_drop_outlined,color: notifier.textColor,),
                                  SizedBox(width: 5,),
                                  Text("Select on map".tr,style: TextStyle(color: notifier.textColor),)
                                ],
                              ),),
                            ),
                          ),
                          const Spacer(),
                        widget.pagestate == true ? const SizedBox() :  InkWell(
                            onTap: () {
                              setState(() {
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 10,),
                                  Text("Add a destination".tr,style: TextStyle(color: notifier.textColor),),
                                  const SizedBox(width: 10,),
                                ],
                              ),
                            ),
                      ...
                      uthertextfilde == true ? const SizedBox() :  picanddrop == true ? const SizedBox() : pickupcontroller.text.isEmpty ? const SizedBox() : GetBuilder<MapSuggestGetApiController>(builder: (mapSuggestGetApiController) {
                        return mapSuggestGetApiController.isLoading ? CircularProgressIndicator(color: theamcolore,) : ListView.builder(
                          physics: const NeverScrollableScrollPhysics(),
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          itemCount: mapSuggestGetApiController.mapApiModel!.results?.length,
                          itemBuilder: (context, index) {
                            return InkWell(
                              onTap: () {
                                ...
                                setState(() {
                                  ...
                                  pickupcontroller.text = mapSuggestGetApiController.mapApiModel!.results![index].name!;
                                  latitudepick = mapSuggestGetApiController.mapApiModel!.results![index].geometry!.location!.lat!;
                                  longitudepick = mapSuggestGetApiController.mapApiModel!.results![index].geometry!.location!.lng!;


                                  picktitle = mapSuggestGetApiController.mapApiModel!.results![index].name!;
                                  picksubtitle = mapSuggestGetApiController.mapApiModel!.results![index].formattedAddress!;
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: ListTile(
                                        ...
                                        leading: Image(image: AssetImage("assets/location-pin.png"),height: 25,color: notifier.textColor,),
                                        title: Transform.translate(offset: const Offset(-10, 0),child: Text("${mapSuggestGetApiController.mapApiModel!.results?[index].name}",style: TextStyle(fontSize: 15,color: notifier.textColor),)),
                                        subtitle: Transform.translate(offset: const Offset(-10, 5),child: Text("${mapSuggestGetApiController.mapApiModel!.results?[index].formattedAddress}",style: const TextStyle(color: Colors.grey,fontSize: 12),maxLines: 2,)),
                                      ),
                                    )
                                  ],
                                ),
                      ...
                      uthertextfilde == true ? const SizedBox() :  picanddrop == false ? const SizedBox() :  dropcontroller.text.isEmpty ? const SizedBox() : GetBuilder<MapSuggestGetApiController>(builder: (mapSuggestGetApiController) {
                        return mapSuggestGetApiController.isLoading ? CircularProgressIndicator(color: theamcolore,) :  ListView.builder(
                          physics: const NeverScrollableScrollPhysics(),
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          ...
                          itemBuilder: (context, index) {
                            return InkWell(
                              onTap: () {
                                print("****:--- ${mapSuggestGetApiController.mapApiModel!.results?[index].name}");
                                setState(() {
                                  print("++++++++++++++++lat++++++++++++++++ ${mapSuggestGetApiController.mapApiModel!.results![index].geometry!.location!.lat!}");
                                  print("++++++++++++++++lng++++++++++++++++ ${mapSuggestGetApiController.mapApiModel!.results![index].geometry!.location!.lng!}");
                                  dropcontroller.text = mapSuggestGetApiController.mapApiModel!.results![index].name!;
                                  latitudedrop = mapSuggestGetApiController.mapApiModel!.results![index].geometry!.location!.lat!;
                                  longitudedrop = mapSuggestGetApiController.mapApiModel!.results![index].geometry!.location!.lng!;


                                  droptitle = mapSuggestGetApiController.mapApiModel!.results![index].name!;
                                  dropsubtitle = mapSuggestGetApiController.mapApiModel!.results![index].formattedAddress!;
                      ...
                      uthertextfilde == false ? const SizedBox() : GetBuilder<MapSuggestGetApiController>(builder: (mapSuggestGetApiController) {
                        return mapSuggestGetApiController.isLoading ? const SizedBox() : ListView.builder(
                          physics: const NeverScrollableScrollPhysics(),
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          itemCount: mapSuggestGetApiController.mapApiModel!.results?.length,
                            ...
                            return InkWell(
                              onTap: () {
                                ...
                                setState(() {
                                  ...
                                  submitDataName();
                                  textfieldlist[textFieldindex].destinationcontroller.text = mapSuggestGetApiController.mapApiModel!.results![index].name!;
                                  destinationlat.add(
                                      PointLatLng(mapSuggestGetApiController.mapApiModel!.results![index].geometry!.location!.lat!, mapSuggestGetApiController.mapApiModel!.results![index].geometry!.location!.lng!)
                                  );
                                  onlypass.add(
                                      {
                                        "lat" : mapSuggestGetApiController.mapApiModel!.results![index].geometry!.location!.lat!,
                                        "long": mapSuggestGetApiController.mapApiModel!.results![index].geometry!.location!.lng!
                                      }
                                  );
                                  ...
                                  droptitlelist.add(
                                      {
                                        "title" : mapSuggestGetApiController.mapApiModel!.results![index].name,
                                        "subt": mapSuggestGetApiController.mapApiModel!.results![index].formattedAddress
                                      }
                                  );
                                  ...
                                  if (pickupcontroller.text.isNotEmpty && dropcontroller.text.isNotEmpty) {
                                    driveridloader = false;
                                    socket.close();
                                    print("++++++++++++++++latitudepick++++++++++++++++ $latitudepick");
                                    print("++++++++++++++++longitudepick++++++++++++++++ $longitudepick");
                                    print("++++++++++++++++latitudedrop++++++++++++++++ $latitudedrop");
                                    print("++++++++++++++++longitudedrop++++++++++++++++ $longitudedrop");
                                    widget.bidding == "1" ? Get.offAll(const MapScreen()) : Navigator.push(
                                      context,
                                      // MaterialPageRoute(builder: (context) =>  HomeScreen(latpic: latitudepick,longpic: longitudepick,latdrop: latitudedrop,longdrop: longitudedrop,destinationlat: destinationlat,destinationlong: destinationlong,)),
                                      MaterialPageRoute(builder: (context) =>  HomeScreen(latpic: latitudepick,longpic: longitudepick,latdrop: latitudedrop,longdrop: longitudedrop,destinationlat: destinationlat)),
                                      // MaterialPageRoute(builder: (context) =>  HomeScreen(latpic: latitudepick,longpic: longitudepick,latdrop: latitudedrop,longdrop: longitudedrop,)),
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        onChanged: (value) {
          // setState(() {
            mapSuggestGetApiController.mapApi(context: context,suggestkey: destinationcontroller.text);
          // });
        },
        decoration: InputDecoration(
