...
class _DriverListScreenState extends State<DriverListScreen> with TickerProviderStateMixin{
        ...
        child: Column(
          children: [
            AppBar(
              ...
              centerTitle: true,
              title: Text("Choose a driver".tr,style: TextStyle(color: notifier.textColor),),
            ),
            Container(
              height: 50,
              width: Get.width,
                ...
                child: Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Driver can offer their fare and time".tr,style: TextStyle(color: notifier.textColor,fontSize: 16),),
                    )
                  ],
                ),
              ),
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            priceyourfare == vehicle_bidding_driver[index]["price"] ?   Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Center(child: Text("Your fare",style: TextStyle(color: Colors.white,fontSize: 12),),),
                                ],
                              ),
                            ) : const SizedBox(),
                              ...
                              child: ListTile(
                               ...
                               leading: Container(
                                 ...
                                 decoration: BoxDecoration(
                                     ...
                                     image: DecorationImage(image: NetworkImage("${Config.imageurl}${vehicle_bidding_driver[index]["profile_image"]}"),fit: BoxFit.cover)
                                 ),
                               ),
                               title: Text("${vehicle_bidding_driver[index]["car_name"]}",style: TextStyle(color: notifier.textColor),),
                               subtitle: Column(
                                 crossAxisAlignment: CrossAxisAlignment.start,
                                 mainAxisAlignment: MainAxisAlignment.start,
                                 children: [
                                   Text("${vehicle_bidding_driver[index]["first_name"]} ${vehicle_bidding_driver[index]["last_name"]}",style: TextStyle(color: notifier.textColor),),
                                   Row(
                                     crossAxisAlignment: CrossAxisAlignment.start,
                                     mainAxisAlignment: MainAxisAlignment.start,
                                     children: [
                                       // const Icon(Icons.star,color: Colors.amber,),
                                       SvgPicture.asset("assets/svgpicture/star-fill.svg",),
                                       const SizedBox(width: 5,),
                                       Padding(
                                         padding: const EdgeInsets.only(top: 6),
                                         child: Text("${vehicle_bidding_driver[index]["avg_star"]}",style: TextStyle(color: notifier.textColor),),
                                       )
                                     ],
                                   )
                                 ],
                               ...
                               trailing:  Column(
                                 ...
                                 mainAxisAlignment: MainAxisAlignment.start,
                                 children: [
                                   Text("$globalcurrency${vehicle_bidding_driver[index]["price"]}",style:  TextStyle(fontSize: 18,color: notifier.textColor),),
                                   // const SizedBox(height: 3,),
                                   // Text("${vehicle_bidding_driver[index]["tot_min"]}",style: const TextStyle(fontSize: 12),),
                                   const SizedBox(height: 5,),
                                   Text("${vehicle_bidding_driver[index]["tot_km"]} km",style:  TextStyle(fontSize: 12,color: notifier.textColor),),
                                 ],
                               ),
                             ),
                            ),
                            ...
                            Row(
                              ...
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                Expanded(child: CommonOutLineButton(bordercolore: Colors.red, onPressed1: () {
                                  print("www:-- ${useridgloable}");
                                  print("www:-- ${vehicle_bidding_driver[index]["id"]}");
                                  print("www:-- ${addVihicalCalculateController.addVihicalCalculateModel!.id}");
                                  socket.emit('Bidding_decline',{
                                    'uid': useridgloable,
                                    'id' : vehicle_bidding_driver[index]["id"],
                                    'request_id' : addVihicalCalculateController.addVihicalCalculateModel!.id,
                                  });
                                },context: context,txt2: "Decline".tr,clore: Colors.red)),
                                const SizedBox(width: 10,),
                                Expanded(child: CommonButton(containcolore: Colors.green, onPressed1: () {
                                  setState(() {
                                    // acceptloader = true;
                                    isanimation = false;
                                    ...
                                    vihicalrice = double.parse(vehicle_bidding_driver[index]["price"].toString());
                                    print("****:-- ${d_id}");
                                    print("****:-- ${price}");
                                ...
                                },context: context,txt1: "Accept".tr))
                              ],
                            ),
                            // const SizedBox(height: 10,),
                            // Row(
