          ...
          child: Column(
            children: [
              ListView.separated(
                  ...
                  shrinkWrap: true,
                  scrollDirection: Axis.vertical,
                  itemCount: faqApiController.faqApiiimodel!.faqList!.length,
                  itemBuilder: (BuildContext context, int index) {
                    return  Container(
                      ...
                      child: ExpansionTile(
                        ...
                        title: Text('${faqApiController.faqApiiimodel!.faqList![index].title}',style:  TextStyle(fontWeight: FontWeight.bold,color: notifier.textColor)),
                        children: <Widget>[
                          Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              const SizedBox(width: 17,),
                              Expanded(child: Text('${faqApiController.faqApiiimodel!.faqList![index].description}',style: TextStyle(color: notifier.textColor),)),
                              const SizedBox(width: 17,),
                            ],
                          ),
                        ],
