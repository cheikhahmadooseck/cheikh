...
import 'package:zippygo/auth_screen/onmobile3_screen.dart';
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("Step 1/2".tr,style: TextStyle(color: Colors.white),),
                    const SizedBox(width: 5,),
                  ],
                ),
                // Spacer(),
                ...
                Padding(
                  ...
                  child: Text("Got an OTP?".tr,style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                )
              ],
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                   Text("Login using the OTP sent ${ccode}${signupmobilecontroller.text}",style: TextStyle(color: notifier.textColor),),
                  ...
                  OTPTextField(
                    ...
                    onChanged: (pin) {
                      setState(() {
                        ...
                        print("++++++widget.otpvariable+++++ :- ${widget.otpvariable}");
            ...
            child: CommonButton(containcolore: theamcolore, onPressed1: (){
                ...
                if (otpvarable2.toString() == smscode) {
                  if (widget.otpvariable == otpvarable2) {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const Onmobile3Screen(),));
                  } else {
