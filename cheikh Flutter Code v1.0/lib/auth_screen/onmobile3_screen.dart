...
import 'package:zippygo/api_code/signup_controller.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                          ...
                          child: SvgPicture.asset("assets/svgpicture/lestarroe.svg",color: Colors.white,height: 35,)),
                      // const Expanded(
                      ...
                      Text("Step 2/2".tr,style: TextStyle(color: Colors.white),),
                      const SizedBox(width: 5,),
                    ],
                  ),
                  // Spacer(),
                  ...
                  Padding(
                    ...
                    child: Text("Just one last thing".tr,style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                  )
                ],
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Full Name".tr,style: TextStyle(color: notifier.textColor),),
                        const SizedBox(height: 10,),
                        CommonTextfiled200(txt: "Name".tr, context: context,controller: namecontroller),
                        const SizedBox(height: 15,),
                        Text("Email".tr,style: TextStyle(color: notifier.textColor),),
                        const SizedBox(height: 10,),
                        CommonTextfiled200(txt: "email".tr, context: context,controller: emailcontroller),
                        const SizedBox(height: 15,),
                        Text("Password".tr,style: TextStyle(color: notifier.textColor),),
                        const SizedBox(height: 10,),
                        CommonTextfiled200(txt: "Password".tr, context: context,controller: passwordcontroller),
                        const SizedBox(height: 15,),
                        Text("Referral code(optional)".tr,style: TextStyle(color: notifier.textColor),),
                        const SizedBox(height: 10,),
                        TextFormField(
            ...
            Padding(
              ...
              child: CommonButton(containcolore: theamcolore, onPressed1: (){
                if (_formKey.currentState!.validate()) {
                  ...
                  signupController.signupApi(context: context,name: namecontroller.text, email: emailcontroller.text, ccode: ccode, mobilenumber: signupmobilecontroller.text, password: passwordcontroller.text, referral_code: refercontroller.text.isEmpty ? "" : refercontroller.text);

                  // Navigator.push(context, MaterialPageRoute(builder: (context) => const Permission_screen(),));


                }
              },context: context,txt1: "Let's go!".tr),
            )
          ],
        ),
      ),
