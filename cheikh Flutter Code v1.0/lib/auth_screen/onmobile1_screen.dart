             ...
             children: [
               ...
               Row(
                 ...
                 children: [
                   ...
                   Text("Step 1/3".tr,style: TextStyle(color: Colors.white),),
                   const SizedBox(width: 5,),
                 ],
               ),
               // Spacer(),
               ...
               Padding(
                 ...
                 child: Text("Let's get you trip-ready!".tr,style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
               )
             ],
           ),
         ),
