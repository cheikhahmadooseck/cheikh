...
import 'package:zippygo/auth_screen/onmobile1_screen.dart';
      ...
      child: Column(
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              _currentPage == 0
                  ? "Book a ride in just a few taps and reach your destination comfortably".tr
                  .tr
                  : _currentPage == 1
                  ? "Experience fast, reliable, and safe rides with ease.".tr
                  .tr
                  : _currentPage == 2
                  ? "Find a ride quickly and enjoy your journey hassle-free".tr
                  .tr
                  : "",
              textAlign: TextAlign.center,
              style: TextStyle(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text("By clicking Continue.you agree tp our ".tr,style: TextStyle(color: notifier.textColor),),
                              Text("T&Cs".tr,style: TextStyle(color: theamcolore, decoration: TextDecoration.underline,)),
                            ],
                          ),
                          const SizedBox(height: 15,),
                          CommonButton(containcolore: theamcolore, onPressed1: () {
                            ...
                            if(signupmobilecontroller.text.isEmpty){
                              ...
                              snackbar(context: context, text: "All fields are required");
                            }
                            else{
                                ...
                                if(value['Result'] == true) {
                                  ...
                                  if(signupmobilecontroller.text.isNotEmpty && loginpassword.text.isNotEmpty){
                                    ...
                                    if(loginpassword.text.isEmpty){
                                      ...
                                      snackbar(context: context, text: "Enter Password");
                                    }else{
                                      // Fluttertoast.showToast(msg: "All fields are required.".tr);
                                      snackbar(context: context, text: "All fields are required.");
                                    }
                          ...
                          Row(
                            children: [
                              ...
                              InkWell(
                                        ...
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                const SizedBox(height: 20,),
                                                Text("Forget Password ?".tr,style: TextStyle(color: notifier.textColor,fontSize: 16,fontWeight: FontWeight.bold)),
                                                const SizedBox(height: 10,),
                                                IntlPhoneField(
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Padding(
                                                                    ...
                                                                    child: Column(
                                                                      ...
                                                                      children: [
                                                                        const SizedBox(height: 20,),
                                                                        Text('Awesome'.tr,style: TextStyle(color: notifier.textColor,fontFamily: 'SofiaProBold',fontSize: 20),),
                                                                        const SizedBox(height: 5,),
                                                                        Text('We have sent the OTP to ${ccode}${forgotmobile.text}'.tr,style:  TextStyle(color: notifier.textColor,fontFamily: "SofiaProBold"),),
                                                                        const SizedBox(height: 20,),
                                                                        Center(
                                                                          child: OTPTextField(
                                                                            ...
                                                                            style:  TextStyle(fontSize: 17,color: notifier.textColor,fontFamily: "SofiaProBold"),
                                                                            onChanged: (pin) {
                                                                              setState(() {
                                  ...
                                  child:  Center(child: Text('Forgot Password ?'.tr,style: TextStyle(color: notifier.textColor,fontFamily: "SofiaProBold",fontSize: 14)),)),
