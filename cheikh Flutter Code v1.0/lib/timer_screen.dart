...
class TimerScreen extends StatefulWidget {
  ...
  final int minutes;
  final int secound;
  const TimerScreen({super.key, required this.hours, required this.minutes, required this.secound,});
  @override
...
class _TimerScreenState extends State<TimerScreen> {
  ...
  _connectSocket() async {
    ...
    socket.on('Vehicle_Time_update$useridgloable', (Vehicle_Time_update) {
      ...
      print("Vehicle_Time_update is of type00: ${Vehicle_Time_update.runtimeType}");
