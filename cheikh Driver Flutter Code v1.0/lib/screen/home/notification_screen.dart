...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  CommonNotificationController commonNotificationController = Get.put(CommonNotificationController());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CommonNotificationController>(builder: (commonNotificationController) {
        return Column(
          children: [
            Expanded(
              child: commonNotificationController.isLoading
                  ? commonNotificationController.commonNotificationModel!.ndata.isNotEmpty
                  ? ListView.builder(
                itemCount: commonNotificationController.commonNotificationModel!.ndata.length,
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      title: Row(
                        ...
                        children: [
                          Text(
                            commonNotificationController.commonNotificationModel!.ndata[index].title,
                            style: TextStyle(
                              fontSize: 17,
