...
import 'package:zippygo_driver/screen/home/language_screen.dart';
import 'package:zippygo_driver/screen/home/past_request_screen.dart';
import 'package:zippygo_driver/screen/home/ride_complete_screen.dart';
import 'package:zippygo_driver/screen/home/sound_player.dart';
import 'package:zippygo_driver/screen/map/map_request_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    getData.read("OnOfStatus") == 0 || getData.read("OnOfStatus") == null ? mapLocationUpdateController.sendCurrentLocation() : mapLocationUpdateController.startLiveTracking();
    super.initState();
    ...
    return Scaffold(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                ...
                updateLocationController.updateLocationAPi(lat: lat.toString(), long: long.toString(), status: "off").then((value) {
                    print("+++++++++++++++++++ $value");
                    socket.emit('homemap', {
                  ...
                  onPressed: (){
                    ...
                    AwesomeDialog(
                      ...
                      btnCancel: Padding(
                        ...
                        child: button(text: "Cancel", color: Colors.red,onPress: (){
                          Get.back();
                        }),
                      ),
                      btnOk: button(text: "Yes, Remove", color: appColor,onPress: (){
                        accountDeleteController.deleteAccountApi(context: context).then((value) {
      ...
      body: GetBuilder<CheckVehicleRequestController>(
        ...
        return checkVehicleRequestController.isLoading
            ? checkVehicleRequestController.checkVehicleRequestModel!.requestData.isNotEmpty
                ? Stack(
                    children: [
                      Padding(
                        padding:
                                ...
                                itemBuilder: (context, index) {
                                  return GestureDetector(
                                    onTap: () {
                                      ...
                                      checkVehicleRequestController.checkVehicleRequestModel!.requestData[index].status ==
                                              "0"
                                          ? Get.to(MapScreen(requestID: checkVehicleRequestController.checkVehicleRequestModel!.requestData[index].id.toString()))
                                              ?.then(
                                              (value) {
                                                isLoading = false;
                                                setState(() {});
                                          ...
                                          : checkVehicleRequestController.checkVehicleRequestModel!.requestData[index].status == "1" ||
                                              ...
                                              ? requestDetailController
                                                  .requestDetailApi(
                                                      requestId: checkVehicleRequestController
                                                          .checkVehicleRequestModel!
                                                          .requestData[index]
                                                          .id
                                                          .toString())
                                              ...
                                              : checkVehicleRequestController
                                                          ...
                                                          .status ==
                                                      "7"
                                                  ? Get.to(RideCompleteScreen(requestId: checkVehicleRequestController.checkVehicleRequestModel!.requestData[index].id.toString(), cID: checkVehicleRequestController.checkVehicleRequestModel!.requestData[index].cId.toString(), status: checkVehicleRequestController.checkVehicleRequestModel!.requestData[index].status.toString()))
                                                  : const SizedBox();
                                    },
                                    child: Container(
                                      // height: 150,
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    "${checkVehicleRequestController.checkVehicleRequestModel!.requestData[index].rating}(${checkVehicleRequestController.checkVehicleRequestModel!.requestData[index].rating})",
                                                    style: TextStyle(
                                                      color: notifier.textColor,
                                                      fontSize: 14,
                                                      letterSpacing: 0.5,
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    const Spacer(),
                                                    Text(
                                                      "${checkVehicleRequestController.checkVehicleRequestModel!.requestData[index].perKmPrice}${getData.read("Currency")}/Km",
                                                      style: TextStyle(
                                                        color: notifier.textColor,
                                                        fontSize: 16,
                                                        fontFamily: FontFamily
                                                    ...
                                                    const Spacer(),
                                                    Text(
                                                      "${double.parse(checkVehicleRequestController.checkVehicleRequestModel!.requestData[index].totKm).toStringAsFixed(2)} Km",
                                                      style: TextStyle(
                                                        color: appColor,
                                                        fontSize: 15,
                                                        fontFamily: FontFamily
