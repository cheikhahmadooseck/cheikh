...
import 'package:zippygo_driver/config/config.dart';
...
class RideCompleteScreen extends StatefulWidget {
  ...
  final String cID;
  final String status;
  const RideCompleteScreen({super.key, required this.requestId, required this.cID, required this.status});
...
class _RideCompleteScreenState extends State<RideCompleteScreen> {
  ...
  CompletePriceController completePriceController = Get.put(CompletePriceController());
  ...
  _connectSocket() {
    ...
    socket.on("Vehicle_Ride_Complete${getData.read("UserLogin")['id']}", (data){
      print('****data****-------- ${data}');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    child: FixedTimeline.tileBuilder(
                      theme: TimelineThemeData(
                        ...
                        indicatorTheme: IndicatorThemeData(
                          color: timeLine == 0 ? Colors.red : Colors.green,
                        ),
                      ...
                      builder: TimelineTileBuilder.connected(
                       ...
                       indicatorBuilder: (context, index) {
                        ...
                        indicatorPositionBuilder: (context, index) => 0.25,
                        itemCount: completePriceController.completePriceModel!.addCalculate.length,
                        contentsBuilder: (context, index) => Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              index == completePriceController.completePriceModel!.addCalculate.length - 1 ? const SizedBox() : Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: [
                                      Icon(CupertinoIcons.location_solid,size: 20,color: greyText),
                                      ...
                                      Icon(CupertinoIcons.time,size: 20,color: greyText),
                                      const SizedBox(width: 3),
                                      Text(
                     ...
                     children: [
                       ...
                       Center(
                         child: Container(
                           ...
                           child: Text(
                             completePriceController.completePriceModel!.priceList.cusName[0].toUpperCase(),
                             style: TextStyle(
                       ...
                       Container(
                         ...
                         child: Row(
                           ...
                           children: [
                             SizedBox(
                                 height: 20,
                                 child: Image.asset("assets/image/tick-circle.png")),
                        ...
                        ExpansionTile(
                         ...
                         trailing:  Row(
                           ...
                           children: [
                            ...
                            customTileExpanded
                                ? Icon(Icons.keyboard_arrow_up_outlined,size: 23,color: greyText)
                                : Icon(Icons.keyboard_arrow_down_outlined,size: 23,color: greyText),
                           ],
                         ),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: FadeInImage.assetNetwork(
                                  ...
                                  image: "${Config.imageUrl}${completePriceController.completePriceModel!.paymentData.image}",
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                            ...
                            Text(
                              completePriceController.completePriceModel!.paymentData.name,
                              style: TextStyle(
                                fontFamily: FontFamily.sofiaProBold,
                                fontSize: 18,
                                fontWeight: FontWeight.w500,
      ...
      bottomNavigationBar: buttonStatus == 0
        ...
        color: notifier.containerColor,
          padding: const EdgeInsets.all(10),
          child: button(text: "Next".tr, color: appColor,
            onPress: (){
            setState(() {
              snackBar(context: context, text: "Waiting for the Payment".tr);
            });
            }
          ))
          : Container(
          color: notifier.containerColor,
          padding: const EdgeInsets.all(10),
          child: button(text: "Done".tr, color: appColor,
              onPress: (){
                setState(() {
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Image.asset("assets/image/tick-circle.png",scale: 3.2,),
                              const SizedBox(width: 5),
                               Text(
                          ...
                          GridView.builder(
                            shrinkWrap: true,
                            itemCount: completePriceController.completePriceModel!.reviewList.length,
                            ...
                            return GestureDetector(
                              onTap: (){
                                setState(() {
                                  if(rateReviewController.reviewList.contains(completePriceController.completePriceModel!.reviewList[index].id)){
                                    rateReviewController.reviewList.remove(completePriceController.completePriceModel!.reviewList[index].id);
                                    print("-------remove--------- ${rateReviewController.reviewList}");

                                  }else{
                                    rateReviewController.reviewList.add(completePriceController.completePriceModel!.reviewList[index].id);
                                    print("+++++++Add+++++++ ${rateReviewController.reviewList}");
                                  }
                                });
                              },
                              child: Container(
                                alignment: Alignment.center,
                                decoration: BoxDecoration(
                                    color: rateReviewController.reviewList.contains(completePriceController.completePriceModel!.reviewList[index].id) ? appColor : notifier.containerColor,
                                    borderRadius: BorderRadius.circular(35),
                                    border: Border.all(color: rateReviewController.reviewList.contains(completePriceController.completePriceModel!.reviewList[index].id) ? appColor : notifier.borderColor)
                                ),
                                child:  Text(
                                  completePriceController.completePriceModel!.reviewList[index].title,
                                  style: TextStyle(
                                    fontFamily: FontFamily.sofiaProBold,
                                    fontSize: 13,
                                      color: rateReviewController.reviewList.contains(completePriceController.completePriceModel!.reviewList[index].id) ? whiteColor : notifier.textColor,
                                    letterSpacing: 0.3
                                  ),
                                  maxLines: 2,
                                  textAlign: TextAlign.center,
                          ...
                          const SizedBox(height: 20),
                          button(text: "Done".tr, color: appColor, onPress: (){
                            rateReviewController.rateReviewAPi(context: context, requestId: newRequestId, cID: widget.cID.toString());
                          }),
                          const SizedBox(height: 15),
                          button3(text: "Skip".tr, textColor: notifier.textColor, color: Colors.transparent, borderColor: appColor, onPress: (){
                            setState((){
                              currentIndexBottom = 0;
                              Get.offAll(const BottomBarScreen());
                            });
