...
import 'package:zippygo_driver/screen/map/map_ride_screen.dart';
...
class _MapScreenState extends State<MapScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    getDarkMode();
    mapThemeStyle();
    notificationSoundPlayer.playNotificationSound(url: "${Config.imageUrl}${checkVehicleRequestController.checkVehicleRequestModel!.general.alertTone}");
    socketConnect();
    ...
    requestDetailController.requestDetailApi(requestId: widget.requestID).then((value) {
      ...
      LatLng pickUpLocation = LatLng(
        double.parse(mapData["request_data"]["pick_latlon"]["latitude"].toString()),
        double.parse(mapData["request_data"]["pick_latlon"]["longitude"].toString()),
      );
  ...
  _connectSocket() {
    ...
    socket.on('vehiclerequest', (request) {
      print("-----request222222------------ ${request["requestid"].toString()}");
      print("-----id2222222------------ ${request["driverid"]}");

      if (request["driverid"].toString().contains(getData.read("UserLogin")["id"].toString())) {
        Get.back();
    ...
    socket.on("TimeOut_Driver_VBidding${getData.read("UserLogin")["id"].toString()}", (data) {
    ...
    socket.on("Accept_Bidding${getData.read("UserLogin")["id"].toString()}", (request) {
      print("+++<><><>+++request123456789<><><><><><<>${request}");
      homeStatus = 0;
      requestDetailController.requestDetailApi(requestId: request["requestid"].toString()).then((value) {
        notificationSoundPlayer.stopNotificationSound();
          Get.to(MapRideScreen(time: requestDetailController.requestDetailModel!.requestData.totMinute.toString(), requestId: request["requestid"].toString(),));
        },
      );

    });

    socket.on("Bidding_decline${getData.read("UserLogin")["id"].toString()}", (request) {
      print("+++<><><>+++request123456789<><><><><><<>${request}");
      Get.back();
    });
  ...
  AcceptRequestController acceptRequestController = Get.put(AcceptRequestController());
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        currentIndexBottom = 0;
        setState(() {});
        return requestDetailController.requestDetailModel!.requestData.status == "1"
                          ...
                          children: [
                            GoogleMap(
                              initialCameraPosition: CameraPosition(
                                target: LatLng(
                                    double.parse(requestDetailController.requestDetailModel!.requestData.pickLatlon.latitude.toString()),
                                    double.parse(requestDetailController.requestDetailModel!.requestData.pickLatlon.longitude.toString())),
                                zoom: 16,
                              ),
                            ...
                            Positioned(
                              ...
                              child: ElevatedButton(
                                style: ButtonStyle(
                                  backgroundColor: WidgetStatePropertyAll(notifier.containerColor),
                                      ...
                                      SingleChildScrollView(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                                    ...
                                                    children: [
                                                      ...
                                                      ListView.separated(
                                                        ...
                                                        padding:
                                                            EdgeInsets.zero,
                                                        itemCount:
                                                            requestDetailController.requestDetailModel!.requestData.dropAdd.length,
                                                        separatorBuilder:
                                                            (context, index) =>
                                                                const SizedBox(
                                                                    height: 14),
                                            ...
                                            Padding(
                                              padding:
                                                  const EdgeInsets.symmetric(
                                                      horizontal: 8),
                                              child: GetBuilder<AcceptRequestController>(
                                                  builder: (acceptRequestController) {
                                                return requestDetailController.requestDetailModel!.requestData.biddingStatus == "1" && requestDetailController.requestDetailModel!.requestData.biddAutoStatus == "0"
                                            ...
                                            acceptRequestController.isRequestAccepted != true
                                                ? Column(
                                                    children: [
                                                      const SizedBox(height: 15),
                                                      Padding(
                                            ...
                                            requestDetailController.requestDetailModel!.requestData.biddingStatus == "1" && requestDetailController.requestDetailModel!.requestData.biddAutoStatus == "0"
                                                ? Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                              ...
                                                              return GestureDetector(
                                                                onTap: () {
                                                                  setState(() {
                                                                    ...
                                                                    bidWaitingBottom(price: "${requestDetailController.requestDetailModel!.requestData.driOfferLimite[index]}");
                                                                  });
                                                                },
                                                                child: Container(
                                                                  alignment:
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              SizedBox(
                                                                  ...
                                                                  child:
                                                                  Image.asset(
                                                                    "assets/image/pen.png", color: whiteColor,
                                                                  )),
                                                            ],
                                                          ),
                                                        ),
  ...
  _addMarker11(LatLng position, String id, BitmapDescriptor descriptor,address) async {
    final Uint8List markIcon =
        await getImages11("assets/image/pick_up.png", 80);
                    ...
                    Column(
                      ...
                      children: [
                          ...
                          itemBuilder: (context, index) {
                            return button2(
                                ...
                                onPress: () {
                                  ...
                                  isLoading = false;
                                  homeStatus = 0;
                                  requestDetailController.requestDetailApi(requestId: requestID).then(
                                    (value) {
                                      setState(() {});
                                      Get.to(MapRideScreen(time: timeData[index].toString(), requestId: requestID,));
                                      setState(() {});
                                    },
                                  );
                        ...
                        button(
                            ...
                            color: appColor,
                            onPress: () {
                              Get.offAll(MapRideScreen(
                                requestId: requestID,
                                time: requestDetailController.requestDetailModel!.requestData.totMinute.toString(),
                              ));
                            }),
                      ],
                    ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                       ...
                       Offering(
                         second: requestDetailController.requestDetailModel!.requestData.biddExTime,
                           onTap: () {
                             socket.emit('Vehicle_Bidding', {
                               'uid': getData.read("UserLogin")["id"].toString(),
                               'request_id': requestDetailController.requestDetailModel!.requestData.id.toString(),
