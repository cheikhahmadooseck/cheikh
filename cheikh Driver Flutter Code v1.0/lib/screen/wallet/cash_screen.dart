...
class _CashScreenState extends State<CashScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<TotalCashController>(builder: (context) {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ListView.separated(
                        shrinkWrap: true,
                        itemCount: totalCashController.totalCashModel!.cashData.length,
                          ...
                          return Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 10),
                                    Text(
                                      totalCashController.totalCashModel!.cashData[index].date.toUpperCase(),
                                      style: TextStyle(
                                        color: greyText2,
                                        fontSize: 13,
                                        letterSpacing: 0.5,
                              ...
                              ListView.builder(
                                ...
                                padding: EdgeInsets.zero,
                                itemCount: totalCashController.totalCashModel!.cashData[index].detail.length,
                                itemBuilder: (context, index2) =>
                                    Column(
                                      children: [
                                        ListTile(
                                          title: Text(
                                            totalCashController.totalCashModel!.cashData[index].detail[index2].status == "1" ? "SUCCESS" : "PENDING",
                                            style: TextStyle(
                                              color: totalCashController.totalCashModel!.cashData[index].detail[index2].status == "1" ? Colors
                                                  .green.shade600 : Colors.orange.shade400,
                                              fontSize: 16,
                                              fontFamily: FontFamily.sofiaProBold,
                                            ),
                                          ),
                                          ...
                                          trailing: totalCashController.totalCashModel!.cashData[index].detail[index2].status == "1"
                                              ? Text(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DottedBorder(
                      ...
                      color: addCashController.galleryFileFront == null ? greyText : appColor,
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          getImageFront(ImageSource.gallery, context).then((value) {
                            setState(() {
                              isLoading = false; // Stop loading after image is picked
                            });
                          }).catchError((error) {
                            setState(() {
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: isLoading
                                ? Center(child: CircularProgressIndicator(color: appColor)) // Show loader when loading
                                : addCashController.galleryFileFront == null
                                ? Column(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: FileImage(addCashController.galleryFileFront!),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                  ...
                  addCashController.isLoading ? Row(
                    children: [
                      Expanded(
                        child: InkWell(
                          onTap: () {
                        ...
                        child: InkWell(
                          onTap: () {
                            if (_formKey.currentState?.validate() ?? false) {
                              if (addCashController.selectType != null) {
                                addCashController.addCashApi(context: context);
                              } else {
                                flutterToast(text: "Please Select Type".tr);
                              }
                            }
                          },
                          child: Container(
