...
import 'package:zippygo_driver/screen/wallet/cash_screen.dart';
import 'package:zippygo_driver/screen/wallet/payout_request_screen.dart';
...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<WalletDetailController>(builder: (context) {
        return walletDetailController.isLoading
            ? Column(
                children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Center(
                                      child: SizedBox(
                                          height: 23,
                                          child: Image.asset("assets/image/withdraw.png"))),
                                ),
                                const SizedBox(
                                  width: 7,
                                ),
                  ...
                  walletDetailController.walletDetailModel!.walletData.isNotEmpty
                      ? Expanded(
                          child: Container(
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Column(
                                children: [
                                  ListView.separated(
                                    shrinkWrap: true,
                                    itemCount: walletDetailController.walletDetailModel!.walletData.length,
                                      ...
                                      return Column(
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                const SizedBox(width: 10),
                                                Text(
                                                  walletDetailController.walletDetailModel!.walletData[index].date.toUpperCase(),
                                                  style: TextStyle(
                                                    color: greyText2,
                                                    fontSize: 13,
                                                    letterSpacing: 0.5,
                                          ...
                                          ListView.separated(
                                            ...
                                            itemCount: walletDetailController.walletDetailModel!.walletData[index].detail.length,
                                            itemBuilder: (context, index2) =>
                                                Padding(
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                        walletDetailController.walletDetailModel!.walletData[index].detail[index2].status == "1" ? "Your Earning" : "Your Payout",
                                                        style: TextStyle(
                                                          color: notifier.textColor,
                                                          fontSize: 17,
                                                          fontFamily: FontFamily.sofiaProBold,
                                                      ...
                                                      walletDetailController.walletDetailModel!.walletData[index].detail[index2].status == "1"
                                                          ? Text(
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        walletDetailController.walletDetailModel!.walletData[index].detail[index2].paymentId,
                                                        style: TextStyle(
                                                          color: greyText,
                                                          fontSize: 13,
                                                          fontFamily: FontFamily.sofiaProBold,
                                                      ...
                                                      walletDetailController.walletDetailModel!.walletData[index].detail[index2].paidAmount == "0"
                                                          ? const SizedBox()
                                                          : Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                      ...
                                                      walletDetailController.walletDetailModel!.walletData[index].detail[index2].walletPrice == "0"
                                                          ? const SizedBox()
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                      ...
                      icon: Icon(Icons.keyboard_arrow_down_outlined,size: 20,color: notifier.textColor),
                      isExpanded: true,
                  ...
                  payoutWalletController.selectType == "UPI"
                    ...
                    children: [
                      ...
                      textfield(
                        controller: payoutWalletController.payoutUpiController,
                        labelText: "UPI".tr,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                    ...
                    children: [
                      ...
                      textfield(
                        controller: payoutWalletController.payoutAccountNumberController,
                      ...
                      textfield(
                        controller: payoutWalletController.ifscController,
                      ...
                      Container(
                        ...
                        child: DropdownButton(
                          ...
                          underline: const SizedBox.shrink(),
                          items:
                          BankType.map<DropdownMenuItem<String>>((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Text(
                                value,
                          ...
                          onChanged: (value) {
                            setState(() {
                              payoutWalletController.bankType = value ?? "";
                            });
                          },
                        ),
                      ),
                    ...
                    children: [
                      ...
                      textfield(
                        controller: payoutWalletController.emailIdController,
                          ...
                          onTap: () {
                            if (_formKey.currentState?.validate() ?? false) {
                              if (payoutWalletController.selectType != null) {
                                payoutWalletController.payoutApi(context: context);
                              } else {
                                snackBar(context: context, text: "Please Select Type");
                              }
                            }
                          },
                          child: Container(
