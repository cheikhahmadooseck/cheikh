...
import 'package:zippygo_driver/screen/auth_screen/personal_info.dart';
            ...
            button(text: "CONTINUE".tr, color: appColor,
              ...
              if(loginController.otpCode.isNotEmpty){
                if(widget.otpCode == loginController.otpCode){
                  Get.offAll(PersonalInfo(primaryMobile: loginController.mobileController.text, primaryCode: loginController.ccode));
                }else{
