...
import 'package:zippygo_driver/controller/personal_info_controller.dart';
...
class PersonalInfo extends StatefulWidget {
  ...
  const PersonalInfo(
      {super.key, required this.primaryMobile, required this.primaryCode});
...
class _PersonalInfoState extends State<PersonalInfo> {
  ...
  fun() {
    infoDetailController.infoDetailApi(context: context).then(
      (value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<InfoDetailController>(builder: (infoDetailController) {
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: Padding(
                                  padding: const EdgeInsets.only(top: 16,left: 11,right: 6),
                                  child: Text(
                                    widget.primaryCode,
                                    style: TextStyle(
                                        color: blackColor,
                          ...
                          Container(
                            ...
                            child: IntlPhoneField(
                              controller: personalInfoController.secondaryPhone,
                            ...
                            child: TextFormField(
                              ...
                              decoration:  InputDecoration(
                                ...
                                suffixIcon: InkWell(
                                    onTap: (){
                                      setState(() {
                                        personalInfoController.obscureText = !personalInfoController.obscureText;
                                      });
                                    },
                                    child: personalInfoController.obscureText == false ? Icon(Icons.remove_red_eye,color: greyText,size: 19) : Icon(Icons.visibility_off_rounded,color: greyText,size: 19)),
                          ...
                          Container(
                            ...
                            child: DottedBorder(
                              ...
                              color: personalInfoController.galleryFile == null
                                  ? greyText
                                  : appColor,
                              ...
                              child: InkWell(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    child: personalInfoController.galleryFile ==
                                            null
                                        ? Image.asset(
        ...
        child: GetBuilder<PersonalInfoController>(
          builder: (personalInfoController) {
            return personalInfoController.isLoading
                ? SizedBox(
                height: 40,
                child: Center(child: CircularProgressIndicator(color: appColor))) : button(
                ...
                onPress: () {
                  ...
                  print("${personalInfoController.languageTagController.getTags }");
                  if (personalInfoController.galleryFile != null && widget.primaryMobile.isNotEmpty &&
                      ...
                      personalInfoController.dateController.text.isNotEmpty &&
                      personalInfoController.address.text.isNotEmpty &&
                      personalInfoController.zoneList.isNotEmpty &&
                      personalInfoController.languageTagController.getTags!.isNotEmpty) {
                    setState(() {
                      personalInfoController.isLoading = true;
                    });
                    personalInfoController.personalInfoApi(context: context,primaryCode: widget.primaryCode.toString(), primaryPhone: widget.primaryMobile.toString());
                  } else {
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Transform.translate(
                ...
                child: Tooltip(
                  ...
                  message:
                      'You can add multiple Tags, but each tags must be followed by pressing Enter. '.tr,
          ...
          TextFieldTags(
            ...
            textfieldTagsController: personalInfoController.languageTagController,
