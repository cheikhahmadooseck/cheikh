...
import '../../widget/dark_light_mode.dart';
 ...
 List<String> dropList = <String>['All'.tr, 'Yesterday'.tr, 'Last week'.tr, 'Last month'.tr, 'Last year'.tr];
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  value: dropdownValue,
                                  icon: Icon(Icons.arrow_drop_down, color: notifier.textColor),
                                  iconSize: 24,
                                  ...
                                  onChanged: (String? newValue) {
                                    setState(() {
                                      ...
                                      print("*********'''''''' c$dropdownValue");
                                      if(dropdownValue == "All"){
                                        myEarningController.myEarningApi(context: context,selection: "");
                                      }else if(dropdownValue == "Yesterday"){
                                        myEarningController.myEarningApi(context: context,selection: "yesterday");
                                      }else if(dropdownValue == "Last week"){
                                        myEarningController.myEarningApi(context: context,selection: "lastweek");
                                      }else if(dropdownValue == "Last month"){
                                        myEarningController.myEarningApi(context: context,selection: "lastmonth");
                                      }else if(dropdownValue == "Last year"){
                                        myEarningController.myEarningApi(context: context,selection: "lastyear");
                                      }
                                    });
                                  },
                          ...
                          Center(
                            child: Text(
                              "${getData.read("Currency")}${myEarningController.myEarningModel!.earnings.totPrice}",
                              style: TextStyle(
                                color: notifier.textColor,
                                fontSize: 25,
                                fontFamily: FontFamily.sofiaProBold,
                    ...
                    myEarningController.myEarningModel!.rideData.isNotEmpty
                        ? Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const SizedBox(height: 15),
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemCount: myEarningController.myEarningModel!.rideData.length,
                                  physics: const BouncingScrollPhysics(),
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: Icon(Icons.directions_bike_rounded,color: appColor,size: 22),
