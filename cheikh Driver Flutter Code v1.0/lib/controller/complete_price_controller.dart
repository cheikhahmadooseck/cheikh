...
class CompletePriceController extends GetxController implements GetxService {
  ...
  Future priceDetailAPi({required context,required String requestId, required String cID}) async{
    ...
    var response = await http.post(Uri.parse(Config.baseUrl + Config.priceDetail),body: jsonEncode(body),headers: userHeader);
