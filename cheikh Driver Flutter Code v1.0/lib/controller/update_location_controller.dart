...
class UpdateLocationController extends GetxController implements GetxService {
  ...
  Future updateLocationAPi({required String lat,required String long,required String status}) async{
    ...
    var response = await http.post(Uri.parse(Config.baseUrl + Config.updateLocation),body: jsonEncode(body),headers: userHeader);
