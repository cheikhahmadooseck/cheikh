...
class PersonalInfoController extends GetxController implements GetxService {
  ...
  Future personalInfoApi({required context,required String primaryCode,required String primaryPhone}) async{
    ...
    var request = http.MultipartRequest('POST', Uri.parse(Config.baseUrl + Config.personalInfo));
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                button(text: "CONTINUE", color: appColor,onPress: (){
                  Get.back();
