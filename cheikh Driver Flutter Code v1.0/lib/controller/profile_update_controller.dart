...
import 'package:zippygo_driver/controller/profile_controller.dart';
...
class EditProfileController extends GetxController implements GetxService {
  ...
  editProfileApi({required context,required String firstName,required String lastName})async{
    ...
    xFileImageProfile != null ? request.files.add(await http.MultipartFile.fromPath('profile_image', xFileImageProfile!.path)) : null;
