...
class DriverInfoController extends GetxController implements GetxService {
  ...
  driverInfoApi({required context})async{
    ...
    String finalPreferenceData = preferenceData.replaceAll(RegExp(r'[\[\] ]'), '');
    ...
    var request = http.MultipartRequest('POST', Uri.parse(Config.baseUrl + Config.driverInfo));
    ...
    request.files.add(await http.MultipartFile.fromPath('vehicle_image', xFileImage!.path));
